      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl sm:text-2xl md:text-3xl text-gray-700 mb-6 max-w-4xl mx-auto leading-relaxed">
            AppointmentOS installs a structured AI-powered enrollment workflow that instantly responds, qualifies, and books consultations — so serious student inquiries never go cold.
          </p>
          
          {/* Supporting Line */}
          <p className="text-lg sm:text-xl text-gray-600 mb-10 max-w-3xl mx-auto">
            Built specifically for Study Abroad Agencies.
          </p>
