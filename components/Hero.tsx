      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-8 text-gray-900 leading-tight">
            Stop Losing High-Intent Student Leads Within the First 5 Minutes.
          </h1>
          
          {/* Subheadline */}
          <p className="text-xl sm:text-2xl md:text-3xl text-gray-700 mb-6 max-w-4xl mx-auto leading-relaxed">
            AppointmentOS installs a structured AI-powered enrollment workflow that instantly responds, qualifies, and books consultations — so no serious student inquiry goes cold.
          </p>
          
          {/* Supporting Line */}
          <p className="text-lg sm:text-xl text-gray-600 mb-10 max-w-3xl mx-auto">
            Built specifically for education agencies and enrollment-driven consultants.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            >
              ...
              Request Enrollment Workflow Demo
            </a>
